...
For commands that Compose's installation guide], but I installed it with
...
curl -o docker-compose.yml \
  https://raw.githubusercontent.com/operable/cog/0.15.1/docker-compose.yml

curl -o docker-compose.override.yml \
  https://raw.githubusercontent.com/operable/cog/0.15.1/docker-compose.override.slack_example.yml
----
...
curl -o docker-compose.override.yml \
  https://raw.githubusercontent.com/operable/cog/0.15.1/docker-compose.override.hipchat_example.yml
----
...
Now you can head back to follow the rest of the standard documentation, as the
rest isn't Slack specific. The only caveat is that when creating a chat-handle,
