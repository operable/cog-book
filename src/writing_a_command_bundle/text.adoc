...
----
<1> We only need to install our dependencies once. Note also that `bundle` here refers to the Ruby dependency management tool https://bundler.io[Bundler], and not any Cog-specif executables. We're not even using Cog yet!
