...
It's not a lot of code, and we can run it directly from our terminal, as seen in <<execute-pure-ruby-tweet>>.

[[execute-pure-ruby-tweet]]
.Executing the Pure Ruby `tweet` Command
----
$ export TWITTER_CONSUMER_KEY=XXXX # <1>
...
----
<1> Substiting the appropriate values for our real credentials, of course.
