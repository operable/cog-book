...
Recall also that you can explicitly cause this same behavior by using the <<here Alias, here redirect alias>>. In this case,
...
(The <<me Alias, me redirect alias>>, however, is not available for triggered pipelines.)
