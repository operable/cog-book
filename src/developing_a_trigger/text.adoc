...
.For More Information...
====
* <<Invoking a Trigger, Invoking a Trigger>>
====
...
// The link above is pointing to Command Pipelines section which has not been transferred as of this comment
