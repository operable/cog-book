...
include::src/user_management/text.adoc[]

include::src/useful_issue_searches/text.adoc[]

include::src/contributor_license_agreement/text.adoc[]
...
include::src/reference/command_output_tags.adoc[]

include::src/reference/greenbar_tags.adoc[]

include::src/reference/chat_adapter_interface.adoc[]
...
include::src/appendices/chat_platforms.adoc[]
